...
layout: post
title: Past and future, a summary of Programming Languages: History and Future
categories:
- programming
- Algol
- APL
...
- FLOWMATIC
---
This post is a (not so short) summary of the wonderful 1972 paper entitled: "Programming Languages: History and Future" by Jean Sammet. She is not only one of the first (computing science) historians but also a language creator.
...
![pls]({{ site.images }}/sammet72-graph.pnh.PNG)
...
The scope of the paper is roughly 20 years, going from 1952 to 1072, when, according to the paper there are about 180 programming languages.
